...
class SkjemapdfViewerTab(SkjemapdfViewer):
    ...
    def __init__(
        self, pdf_folder_path: str, form_identifier: str | None = "skjemaversjon"
    ) -> None:
        """Initializes the SkjemapdfViewerTab class.

        Args:
            pdf_folder_path (str): The path to the folder containing PDF files.
            form_identifier (str | None): The identifier for the form. This should be the VariableSelector value that matches the PDF file name.
